...
void Card::on_render(VertexBatch* batch, bool hovered, bool lowlight) {
    ...
    batch->draw_rectangle(pos.x, pos.y, pos.z, 0.8f, 1.2f, rot, m_type->getUvs(), lowlight ? glm::vec<4, uint8_t>{128,128,128,255} : glm::vec<4, uint8_t>{255,255,255,255});
